...
rs_define('SESSION_START', '2025-01-10');
rs_define('SESSION_END', '2025-02-25');

# ENVIRONMENT
# Set to false for Docker/development, true for production
rs_define('IS_PRODUCTION', false);
...
rs_define('MEMCACHED_SERVER', 'memcached');
