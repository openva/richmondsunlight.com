...
STRUCTURE=(bills bills_copatrons bills_full_text bills_places bills_section_numbers bills_status bills_views blacklist chamber_status comments comments_subscriptions committees committee_members dashboard_bills dashboard_portfolios dashboard_user_data dashboard_watch_lists districts dockets files fiscal_impact_statements gazetteer meetings minutes polls people representatives representatives_districts representatives_votes sessions tags terms users vacode video_clips video_index video_index_faces video_transcript votes)

# All database tables that we want to export all contents of
ALL_CONTENTS=(committees committee_members districts files people representatives representatives_districts sessions terms)
