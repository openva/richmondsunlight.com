...
$page_body = <<<EOD
		...
		<p>INDEMNITY<br />
		You agree to indemnify and hold Richmond Sunlight, and its subsidiaries,
		...
		and resources, you acknowledge and agree that Richmond Sunlight is not
		...
		further acknowledge and agree that Richmond Sunlight shall not be responsible or
		...
		USE, DATA OR OTHER INTANGIBLE LOSSES (EVEN IF RICHMOND SUNLIGHT HAS BEEN ADVISED
		...
		Sunlight the royalty-free, perpetual, irrevocable, non-exclusive, transferable
		license to use, reproduce, modify, publish, translate, adapt, create derivative
		works from, perform, display, and distribute such content (in part or in whole)
		...
		Richmond Sunlight. You also may be subject to additional terms and conditions
		that may apply when you use affiliate services, third-party content or
		third-party software. The TOS and the relationship between you and Richmond
		Sunlight shall be governed by the laws of the Commonwealth of Virginia without
		regard to its conflict of law provisions. You and Richmond Sunlight agree to
		submit to the personal and exclusive jurisdiction of the courts located within
		the city of Richmond, Virginia. The failure of Richmond Sunlight to exercise
