<?php
	...
	# PAGE CONTENT
	$page_body = '<p>We&rsquo;re sorry, but the site is totally overwhelmed with traffic right now. There are more people trying to look at the site than we can show it to at once.
