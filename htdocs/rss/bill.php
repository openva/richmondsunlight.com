<?php
    ...
    # LOCALIZE VARIABLES
    $bill['number'] = mb_strtolower($_REQUEST['number']);
...
<rss version="0.91">
	<channel>
		<title>' . mb_strtoupper($bill['number']) . ' Status</title>
		<link>http://www.richmondsunlight.com/bill/' . SESSION_YEAR . '/' . $bill['number'] . '/</link>
		<description>The activity of bill ' . mb_strtoupper($bill['number']) . ' in the '
