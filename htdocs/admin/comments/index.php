    ...
    while ($comment = mysqli_fetch_array($result))
    {
        $page_body .= '
			<div class="comment"' . (($comment['status'] == 'deleted') ? ' style="color: #999;"' : '') . '>
				<h2><a href="/bill/' . SESSION_YEAR . '/' . mb_strtolower($comment['bill_number']) . '/">' . $comment['bill_number'] . '</a>:
				...
				<div class="metadata">
					...
					<a href="/bill/' . SESSION_YEAR . '/' . mb_strtolower($comment['bill_number']) . '/#comments">#</a>
				</div>
