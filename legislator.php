...
# Google Map
if (!empty($legislator['latitude']) && !empty($legislator['longitude']))
{

	$page_sidebar .= '
	<div id="map" style="width: 100%; height: 150px;">
		<img src="https://maps.googleapis.com/maps/api/staticmap?center=' . $legislator['longitude'] . ','
		. $legislator['latitude'] . '&amp;zoom=6&amp;size=215x150&amp;markers='
		. $legislator['longitude'] . ',' . $legislator['latitude'] . '&amp;key=' . GMAPS_KEY . '" alt="" />
	</div>';
}
